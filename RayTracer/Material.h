...
public: 
	...
	virtual bool Scatter(const ray_t& r, const raycastHit_t& hit, glm::vec3& attenuation, ray_t& scattered) const = 0;
...
{
public:
	Dielectric(const glm::vec3& albedo, float refractionIndex) : albedo{ std::make_shared<ColorSampler>(albedo) }, refractionIndex{
	refractionIndex } {}
